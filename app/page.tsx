  ...
  return (
    <main>
      <section className="h-dvh ">
        <h1 className={`text-font w-full md:w-[80%] absolute text-[40px] md:text-[50px] bg-main left-0  md:left-35 md:bottom-8 bottom-0 text-center ${instrumentSerif.className}`}>&apos;&apos;Your Real Estate Partner to help you sell, rent, buy and let.&apos;&apos;</h1>
      ...
      <section className="relative h-screen">
        ...
        <div className="bg-main left-20 top-20 absolute text-center px-2 md:px-10 py-5 w-[50%] shadow-lg shadow-black/40 ">
        ...
        <div className="bg-main left-0 bottom-0 md:right-20 md:bottom-20 absolute text-center px-10 py-5 w-full md:w-[50%] shadow-lg shadow-black/40 ">
          <p className={`${instrumentSerif.className} text-font text-xl md:text-3xl lg:text-4xl`}>50 years Experience, Business built on trust and integrity. Customized plans to fit your needs, Experts in local and international property.</p>
        </div>
      </section>
