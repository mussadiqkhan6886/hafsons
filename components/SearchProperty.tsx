  ...
  return (
    <section className="absolute top-20 w-full px-20">
        ...
        <div className="flex gap-10 px-50">
          ...
          <input type="search" id="search" placeholder="Area or postcode" className="outline-none w-full py-2 px-3 border-none text-white backdrop-blur-[6px]  bg-gray-200/50 text-lg" />
